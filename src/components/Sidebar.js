...
export default function Sidebar({ data }) {
  ...
  return loading ? (
    ...
    <div className='transition md:hidden px-5 overflow-hidden duration-700 w-full bg-blue-600 ease-in-out flex flex-col absolute h-full overflow-hidden gap-5'>
      ...
      <div className='profile rounded-xl p-3 bg-blue-100 bg-opacity-40 flex items-center gap-2'>
        <img
          className='profile-img w-20 rounded-full  bg-gray-500 border-2 border-gray-200'
          alt='test'
          src={Logo}
        />
        <div className='flex flex-col items-start'>
          ...
          <div className='text-center email font-semibold text-xs overflow-scroll text-gray-100'>
      ...
      <div className='flex flex-col items-center divide-y divide-gray-600 gap-2'>
        <Link
          className='nav flex self-start items-center gap-5  text-gray-50'
          to='/'
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
